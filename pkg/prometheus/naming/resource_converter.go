...
type ResourceConverter interface {
	...
	ResourcesForSeries(series prometheus.Series) (res []schema.GroupResource, namespaced bool)
...
func (r *resourceConverter) ResourcesForSeries(series prometheus.Series) ([]schema.GroupResource, bool) {
